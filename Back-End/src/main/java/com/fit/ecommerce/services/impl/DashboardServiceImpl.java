...
import com.fit.ecommerce.dtos.projection.TopProductProjection;
import com.fit.ecommerce.dtos.projection.TopPromotionProjection;
import com.fit.ecommerce.dtos.projection.TopVoucherProjection;
import com.fit.ecommerce.dtos.response.dashboard.*;
import com.fit.ecommerce.entities.OrderDetail;
import com.fit.ecommerce.entities.PromotionUsage;
import com.fit.ecommerce.exceptions.ErrorCode;
import com.fit.ecommerce.exceptions.custom.ResourceNotFoundException;
import com.fit.ecommerce.repositories.OrderDetailRepository;
import com.fit.ecommerce.repositories.OrderRepository;
import com.fit.ecommerce.repositories.PromotionUsageRepository;
import com.fit.ecommerce.repositories.VoucherUsageHistoryRepository;
import com.fit.ecommerce.services.DashboardService;
import com.fit.ecommerce.services.ProductService;
...
public class DashboardServiceImpl implements DashboardService {
    ...
    public VoucherDetailResponse getVoucherDetail(Long voucherId, LocalDate startDate, LocalDate endDate) {
        ...
        List<com.fit.ecommerce.entities.VoucherUsageHistory> usageHistories = 
        ...
        if (usageHistories.isEmpty()) {
            ...
            var voucher = voucherUsageHistoryRepository.findFirstByVoucherId(voucherId)
                    .map(com.fit.ecommerce.entities.VoucherUsageHistory::getVoucher)
    ...
    public List<OrderSummaryResponse> getOrdersByDateRange(LocalDate startDate, LocalDate endDate) {
        ...
        var orders = orderRepository.findByOrderDateBetweenAndStatus(
                ...
                com.fit.ecommerce.enums.OrderStatus.COMPLETED
        );
