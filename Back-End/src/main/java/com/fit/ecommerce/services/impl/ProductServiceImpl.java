...
import com.fit.ecommerce.dtos.request.product.ProductAttributeRequest;
import com.fit.ecommerce.dtos.request.product.ProductUpdateRequest;
import com.fit.ecommerce.dtos.request.product.ProductVariantRequest;
...
public class ProductServiceImpl implements ProductService {
    ...
    public PageResponse<ProductResponse> searchProductForUser(String categorySlug, int page, int size, Map<String, String> filters) {
        ...
        Page<Product> productPage = productRepository.findAll(
            com.fit.ecommerce.specifications.ProductSpecification.filterProducts(
